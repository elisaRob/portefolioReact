                       ...
                       Bonjour,<br/><br/>
                        ...
                        Cependant, j'ai décidé de réaliser mon rêve en me reconvertissant dans le développement web. Animée par une motivation exceptionnelle, je travaille avec acharnement et je m'immerge profondément dans chaque sujet.
                         ...
                         <strong>Ma détermination et mon esprit travailleur</strong> sont des caractéristiques qui me définissent, faisant de moi une personne résolue et engagée.<br/>
                          J'ai entamé ma formation en autodidacte, et actuellement, je poursuis une formation professionnelle au CNAM où je travaille à l'obtention du diplôme bac+2 de<a className="lienUtile" href="https://cnam-idf.fr/formations/hors-temps-de-travail/diplomes/titre-rncp-niveau-5-concepteur-developpeur-de-solutions-informatiques-crn0700a"> technicien developpeur avec le CNAM</a>.<br/>
                         J'ai suivi en parallèle la formation de <a className="lienUtile" href="https://fabdunum.fr/">la Fabrique du Numérique</a> qui m'a beaucoup considérablement aidée à perfectionner mes compétences. 
