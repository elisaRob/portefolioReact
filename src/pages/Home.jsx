    ...
    return(
       <div className="accueil">
            <div className="quiSuisJe">
                ...
                <div className="paragrapheQuiSuisJe">
                    <p>
                       Bonjour,<br/><br/>
                        ...
                        Cependant, j'ai décidé de réaliser mon rêve en me reconvertissant dans le développement web. Animée par une motivation exceptionnelle, je travaille avec acharnement et je m'immerge profondément dans chaque sujet.
                         <br/><br/>
                         <strong>Ma détermination et mon esprit travailleur</strong> sont des caractéristiques qui me définissent, faisant de moi une personne résolue et engagée.
                          J'ai entamé ma formation en autodidacte, et actuellement, je poursuis une formation professionnelle au CNAM où je travaille à l'obtention du diplôme bac+2 de<a href="https://cnam-idf.fr/formations/hors-temps-de-travail/diplomes/titre-rncp-niveau-5-concepteur-developpeur-de-solutions-informatiques-crn0700a"> technicien developpeur avec le CNAM</a>.
                         J'ai suivi en parallèle la formation de <a href="https://fabdunum.fr/">la Fabrique du Numérique</a> qui m'a beaucoup considérablement aidée à perfectionner mes compétences. 
